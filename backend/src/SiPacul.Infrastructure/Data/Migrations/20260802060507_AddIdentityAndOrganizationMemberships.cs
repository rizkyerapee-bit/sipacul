...
{
    /// <inheritdoc />
    public partial class AddIdentityAndOrganizationMemberships : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_OrganizationMemberships_Org_Id", x => new { x.OrganizationId, x.Id });
                    table.ForeignKey(
                        name: "FK_OrganizationMemberships_Organization",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganizationMemberships_User",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationMemberships_IsDeleted",
                table: "OrganizationMemberships",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationMemberships_Org_Status",
                table: "OrganizationMemberships",
                columns: new[] { "OrganizationId", "Status", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationMemberships_User_Status",
                table: "OrganizationMemberships",
                columns: new[] { "UserId", "Status", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "UX_OrganizationMemberships_Org_User",
                table: "OrganizationMemberships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_Active_LockoutEnd",
                table: "Users",
                columns: new[] { "IsActive", "LockoutEnd" });
